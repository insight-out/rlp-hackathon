<template>
  ...
  >
    <div class="w-full max-w-md text-center px-3">
      <p class="mb-2 text-gray-700 font-semibold font-sans tracking-wide">08:00 - 08:30</p>
      <draggable
        tag="ul"
        group="all-users"
    ...
    <div class="w-full max-w-md md:ml-6 text-center px-3">
      <p class="mb-2 text-gray-700 font-semibold font-sans tracking-wide">08:30 - 09:00</p>
      <draggable
        tag="ul"
        group="all-users"
        class="draggable-list"
