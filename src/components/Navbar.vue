        ...
        >
          <div class="hidden sm:block sm:ml-6">
            <div class="flex" style="margin-left: -40px">
              ...
              <a
                href="#"
                class="ml-4 px-3 py-2 rounded-md font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out"
                style="white-space: nowrap; display: inline-block;"
                >Mainz <ChevronDownIcon style="display: inline-block;"
              /></a>
            </div>
          </div>
        </div>
